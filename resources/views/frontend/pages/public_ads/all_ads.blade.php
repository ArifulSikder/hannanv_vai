                            ...
                            html += '<div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-xs-6 mb-20">\
                                                                        <div class="product-single-item">\
                                                                            <a href="javascript:openPage()">\
                                                                                ...
                                                                                <div class="thumb">\
                                                                                    <img src="core/public/storage/image/' +item[i]['image'] + ' " alt="product">\
                                                                                </div>\
                                                                                <div class="content">\
                                                                                    <span class="sub-title">' + item[i][
                                    'city'
                                ]
                                [
                                    'title'
                                ] + '</span>\
                                                                                    <h5 class="title">' + item[i][
                                'title'] + '</h5>\
                                                                                    <span class="inner-sub-title">' + item[
                                    i][
                                    'category'
                                ][
                                    'title'
                                ] + '</span>\
                                                                                    <h5 class="inner-title">' + item[i][
                                    'price'
                                ] + ' TL</h5>\
                                                                                </div>\
                                                                            </a>\
