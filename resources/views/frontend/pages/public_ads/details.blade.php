...
@section('content')
                            ...
                            <div class="product-details-content">
                                <div class="top-area">
                                    <div class="top-wrapper">
                                        <h2 class="price-title">{{ $details->price }} TL</h2>
                                        <div class="opsition-wrapper">
                                            <a class="opsition-item"
                                                href="{{ route('frontend.user.favourite', $details->id) }}">
                                ...
                                <div class="center-area">
                                    ...
                                    <div class="product-details-list-area">
                                        @if (!empty($details->details_informations) && $details->details_informations != null)
                                            <ul class="product-details-list proudct_info">
                                                @foreach (json_decode($details->details_informations) as $key => $details_info)
                                                    <li>{{ str_replace('_', ' ', ucfirst($key)) }}</strong> &nbsp;{{ $details_info }}
                                                    </li>
                                                @endforeach
                                            </ul>
                                        @else
                                        ...
                                        @if (isset($details->fuel_type) && $details->fuel_type != null)
                                            <ul class="product-details-list proudct_info">
                                                <li>Fuel Type: {!! str_replace('"', ' ', (string) $details->fuel_type) !!} </li>
                                            </ul>
                                        @endif
                                    ...
                                    <div class="bottom-area">
                                        <div class="title-wrapper">
                                            <h4 class="title">
                                                Condition: @if ($details->condition == 'Like New')
                                ...
                                <div class="seller-profile-card">
                                    ...
                                    <div class="seller-profile-card-top-wrapper">
                                        <div class="thumb-area">
                                            <div class="thumb">
                                                <img src="{{ URL::asset('core/public/storage/user/' . $details->advertiser->image) }}" alt="img">
                                            </div>
                                            <div class="thumb-content-area">
                                                <div class="thumb-content">
                                                    <a href="#" class="seller-profile-card-top-link">
                                                        <span class="title">{{ $details->advertiser->first_name }}</span>
                                                    </a>
                                    ...
                                    <div class="seller-profile-card-bottom-wrapper">
                                        <span class="title">Message the seller :</span>
                                        <div class="seller-profile-bottom-btn">
                                            <a href="#" class="btn--base">Is it still available?</a>
                                            <a href="#" class="btn--base">Is the price negotiable?</a>
                                            <a href="#" class="btn--base">What condition is it in?</a>
                                        </div>
                                        <form class="chat-with-seller-form" action="{{ route('frontend.detailsSendMessage') }}" method="post">
                                            @csrf
                                            <input type="hidden" name="recever_id" value="{{ $details->advertiser_id }}">
                                            <input type="hidden" name="advertisement_id" value="{{ $details->id }}">
                                            <input type="hidden" name="advertisement_title" value="{{ $details->title }}">
                                            <input type="hidden" name="advertisement_price" value="{{ $details->price }}">
                                            <input type="hidden" name="advertiser_id" value="{{ $details->advertiser_id }}">
    ...
    @if (count($related_products))
        <section class="product-section pt-30 mb-2">
            <div class="container">
                <h2 class="product-section-header-title pb-10">You may also like</h2>
